  ...
  async runGstr1AggregationForCustomer(
    ...
    for (const uploadRow of uploadRows) {
      ...
      rows.push({
        ...
        aggregationVariable: mergeAggregationVariable(existingJson, {

          ...preserveMetricKeys(existingJson, PRIMARY_GST_COMPLIANCE_METRIC_KEYS),
    ...
    for (const uploadRow of uploadRows) {
      ...
      rows.push({
        ...
        aggregationVariable: mergeAggregationVariable(
          ...
          existingByLoan.get(uploadRow.associated_loan_id) ?? null,

          {

            ...preserveMetricKeys(

              existingByLoan.get(uploadRow.associated_loan_id),
